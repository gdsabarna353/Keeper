...
function Home() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("userEmail") !== null) {
      fetch("https://keeper-backend-p6ex.onrender.com/home", {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  useEffect(() => {
    if (localStorage.getItem("userEmail") === null) {
      fetch("https://keeper-backend-p6ex.onrender.com/auth/login/success", {
        method: "GET",
        credentials: "include",
        headers: {
          Accept: "application/json",
  ...
  function deleteNote(id) {
    ...
    fetch("https://keeper-backend-p6ex.onrender.com/delete", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function editNote(id, obj) {
    ...
    fetch("https://keeper-backend-p6ex.onrender.com/edit", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
